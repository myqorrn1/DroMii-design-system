...
- **1차 후보**: 기본 구조 견본은 있으나 상세 상태나 업무 흐름을 더 설계해야 함
...
| Table | 1차 후보 | [기본 사용 기준](DATA_TABLE.md) 마련. 고정 헤더, 가로 넘침, 선택 작업 표시줄 |
...
| Form layout | 1차 후보 | KRDS 기준으로 1열 기본·관련 필드 2열 예외. 이탈 경고와 실제 업무 검증 |
