...
> 현재 배포본은 기존 제품을 실측해 만든 v0.12 초안입니다. 공용 토큰, 실제 컴포넌트,
> 사내 문서 사이트를 하나의 코드 기준으로 관리하는 방향으로 다음 버전을 준비합니다.
>
...
동시에 각 제품의 컨셉은 유지되어야 하므로, 갈라지는 지점을 미리 정해 뒀습니다 —
**강조 색상 · 로고 · 로그인 배경 · 도메인 아이콘, 네 가지뿐**입니다.
