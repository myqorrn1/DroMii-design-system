...
> K-AQUAS와 D-ROAD의 코드에서 공통 구조를 추출한 Core 검토본입니다.
> 공용 토큰, HTML·CSS 컴포넌트 견본, 사내 문서 사이트를 하나의 코드 기준으로 관리합니다.
>
...
- 현재 Core 후보의 컴포넌트 상태와 상호작용을 먼저 완성
- 제품별 밀도와 지도 도구의 상세 동작 확정
